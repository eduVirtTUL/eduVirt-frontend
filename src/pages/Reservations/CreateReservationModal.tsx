...
import {useCreateReservation} from "@/data/reservation/useCreateReservation.ts";
import {z} from "zod";
...
const CreateReservationModal: React.FC<ResourceGroupProps> = ({resourceGroupId, start, end, resetSelection}) => {
    ...
    const handleSubmit = form.handleSubmit(async (values: CreateReservationSchema) => {
        const startTime = new Date(start!);
        const tempDate = new Date(startTime);
        const endTime = new Date(tempDate.setHours(tempDate.getHours() + values.reservationDuration));
