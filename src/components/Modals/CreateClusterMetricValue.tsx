...
import {useCreateClusterMetricValue} from "@/data/cluster-metrics/useCreateClusterMetricValue.ts";
...
type CreateClusterMetricValueSchema = z.infer<typeof createClusterMetricValueSchema>;
...
const CreateClusterMetricValueModal: React.FC<CreateClusterMetricValueProps> = ({clusterId}) => {
    ...
    const handleSubmit = form.handleSubmit(async (values: CreateMetricValueDto) => {
