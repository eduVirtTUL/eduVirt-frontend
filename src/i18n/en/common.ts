...
const errorKeys = {
  ...
  "access.key.not.found.exception": "Access key has not been found",
  "access.key.already.exists": "The access key for this course already exists",
  "access.key.invalid.format": "The access key format is invalid",
  "access.key.invalid.type": "The access key type is invalid",
  "access.key.duplicate": "An access key with the provided value already exists. Try again",
