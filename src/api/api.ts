...
export const ReservationControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getReservationsForGivenPeriod: async (start: string, end: string, timezone: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'start' is not null or undefined
            assertParamExists('getReservationsForGivenPeriod', 'start', start)
            // verify required parameter 'end' is not null or undefined
            assertParamExists('getReservationsForGivenPeriod', 'end', end)
            // verify required parameter 'timezone' is not null or undefined
            assertParamExists('getReservationsForGivenPeriod', 'timezone', timezone)
...
export const ReservationControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getReservationsForGivenPeriod(start: string, end: string, timezone: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ReservationDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getReservationsForGivenPeriod(start, end, timezone, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ReservationControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getReservationsForGivenPeriod(start: string, end: string, timezone: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<ReservationDto>> {
            return localVarFp.getReservationsForGivenPeriod(start, end, timezone, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ReservationControllerApi extends BaseAPI {
     ...
     * @memberof ReservationControllerApi
     */
    public getReservationsForGivenPeriod(start: string, end: string, timezone: string, options?: RawAxiosRequestConfig) {
        return ReservationControllerApiFp(this.configuration).getReservationsForGivenPeriod(start, end, timezone, options).then((request) => request(this.axios, this.basePath));
    }
}
